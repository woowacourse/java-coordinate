...
public class FigureFactoryTest {
    ...
    private FigureCreator figureCreator=new FigureFactory();


    @Test
    void Line_생성_테스트(){
        Figure figure=figureCreator.create(LinePoints);
        assertThat(figure.getClass()).isEqualTo(Line.class);
    }

    @Test
    void Triangle_생성_테스트(){
        Figure figure=figureCreator.create(TrianglePoints);
        assertThat(figure.getClass()).isEqualTo(Triangle.class);
    }

    @Test
    void Rectangle_생성_테스트(){
        Figure figure=figureCreator.create(RectanglePoints);
