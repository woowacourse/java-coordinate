...
class FigureFactoryTest {
    ...
    @Test
    void 좌표_세개() {
        Points points = new Points(Arrays.asList(new Point(1, 0), new Point(3, 0), new Point(2, 1)));
        assertThat(FigureFactory.generateFigure(points)).isEqualTo(new Triangle(points));
    }

    @Test
    void 좌표_네개() {
        Points points = new Points(Arrays.asList(new Point(1, 0), new Point(3, 0), new Point(1, 1), new Point(3, 1)));
